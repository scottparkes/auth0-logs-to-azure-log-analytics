...
config.output.filename = 'logs-to-azure-log-analytics.ui.' + project.version + '.js';
...
config.plugins = config.plugins.concat([
  ...
  new ExtractTextPlugin('logs-to-azure-log-analytics.ui.' + project.version + '.css', {
    allChunks: true
  }),

  // Separate the vender in a different file.
  new webpack.optimize.CommonsChunkPlugin('vendors', 'logs-to-azure-log-analytics.ui.vendors.' + project.version + '.js'),
