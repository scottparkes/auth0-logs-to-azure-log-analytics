...
export function logout() {
  return (dispatch) => {
    localStorage.removeItem('logs-to-azure-log-analytics:apiToken');
    sessionStorage.removeItem('logs-to-azure-log-analytics:apiToken');
...
export function loadCredentials() {
  return (dispatch) => {
    const apiToken = sessionStorage.getItem('logs-to-azure-log-analytics:apiToken');
    if (apiToken) {
